                                ...
                                <ul className='scroll_address'  key={address._id}>
                                    ...
                                    <li>
                                        <div className="d-flex justify-content-end">
                                            <button type='button' className={address.default ? 'text-success border border-white bg-white' : 'text-muted border border-white bg-white'} onClick={() => defaultAddress(address._id)}>
                                                Escolher
                                            </button>
