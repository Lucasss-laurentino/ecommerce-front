...
export const Cart = () => {
    ...
    const { getProductsThisUser, productsThisUser, selectProduct, productsSelected, total } = useContext(CartContext);
                                    ...
                                    <div className="row">
                                        ...
                                        <div className="col-lg-7">
                                            ...
                                            <div className="d-flex justify-content-between align-items-center mb-4">
                                                <div>
                                                    <p className="mb-0">Você tem {productsThisUser.length} itens no carrinho</p>
                                                </div>
                                            </div>
                                            <div className="container scroll-cards">
                                                {productsThisUser.map((productThisUser) => {
                                                    return (
                                                        <React.Fragment key={productThisUser[0]['id']}>
                                                            <div className="card-border mb-3">
                                                                <div className="card-body">
                                                                    <div className="d-flex justify-content-end align-items-center">
                                                                        <button className='bg-white text-danger border border-white' >
                                                                    ...
                                                                    <div className="d-flex justify-content-between">
                                                                        <input type="checkbox" name={productThisUser[0]['name']} className='m-2' id={productThisUser[0]['name']}  onClick={() => selectProduct(productThisUser[0])}/>
                                                                        <div className="d-flex color flex-row align-items-center">
                                                                            <div className='col-7'>
                                                                                <img
                                                                                    src={productThisUser[0]['imageOne']}
                                                                                    className="img-fluid" alt="Shopping item" />
                                                                            </div>
                                                                            <div className="col-5">
                                                                                <h5 className='text_responsive'>{productThisUser[0]['name']}</h5>
                                                                            </div>
                                                                        </div>
                                                                        <div className="d-flex justify-content-end flex-row align-items-center col-3 col-lg-3 col-sm-3 col-md-4">
                                                                            <div className=''>
                                                                                <h5 className='text_responsive'>R$:{productThisUser[0]['price']}</h5>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                </div>
