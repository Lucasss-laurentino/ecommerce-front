...
export default function ModalCategory({ modalCategory, setModalCategory }: Props) {
    ...
    const handleSubmit = (event: React.FormEvent<HTMLFormElement>) => {
        ...
        if(name && imageOne && imageTwo){
            ...
            formData.append('banner', imageOne);
            formData.append('banner', imageTwo);
            ...
            <Modal.Body>
                ...
                <ul className='scrol-list-categories'>
                    {categories?.map((category) =>
                        <li key={category?._id} className="d-flex justify-content-between">
                            ...
                            <div className="container d-flex align-items-center justify-content-end">
                                ...
                                <button className='btn-delete' onClick={() => deleteCategory(category._id)}>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-trash" viewBox="0 0 16 16">
                                        <path d="M5.5 5.5A.5.5 0 0 1 6 6v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5Zm2.5 0a.5.5 0 0 1 .5.5v6a.5.5 0 0 1-1 0V6a.5.5 0 0 1 .5-.5Zm3 .5a.5.5 0 0 0-1 0v6a.5.5 0 0 0 1 0V6Z" />
                                        <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1 1 0 0 1 1 1h3.5a1 1 0 0 1 1 1v1ZM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4H4.118ZM2.5 3h11V2h-11v1Z" />
                                    </svg>
                                </button>
                                <button className={category.default ? 'bg-white border border-white text-success text-decoration-underline' : 'bg-white border border-white text-muted'} onClick={() => categoryDefault(category._id)}>Default</button>
                            </div>
                        </li>
                    )}
                </ul>
                ...
                <div className="container d-flex justify-content-center">
                    <form onSubmit={handleSubmit}>
                        <input type="text" name="name" className='input-form-login' value={name} onChange={(value) => setName(value.target.value)} placeholder='nome da categoria'/>
