        ...
        <>
            ...
            <div className="container d-flex justify-content-between align-items-center mt-3">
                <div className="container">
                    <h1 className="font-garlicha text-decoration-none mb-0">Coisas de mulher</h1>
                </div>
                <div className="container">
                    ...
                    <ul className='px-3'>
                        ...
                        {user &&
                            <>
                                ...
                                {user.adm ?
                                <li className="list-menu my-3">
                                    <button className='d-flex p-0 justify-content-between align-items-center bg-white border border-white text-decoration-none text-dark' onClick={() => setModalCategory(true)}>
                                ...
                                <li className="list-menu my-3">
                                    <button onClick={logout} className='bg-white w-100 border border-white text-dark d-flex justify-content-between align-items-center p-0'>
            ...
            <footer className="bottom-fixed footer-custom">
                <section className="">
